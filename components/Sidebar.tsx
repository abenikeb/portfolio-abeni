  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="sideh3">Via Telegram</span>
      </a>
      {/* git-Hub  */}
      <a
        href="https://github.com/abenikeb"
        target="_blank"
        className="py-2 text-color3 fc an hover:animate-pulse "
        rel="noreferrer"
      >
        <AiFillGithub className=" h-7 w-7" />
        <span className="font-mono sideh3">My Github repo</span>
      </a>
      {/*address */}
      <div
      ...
      >
        <div className=" justify-end flex gap-x-3 items-center min-w-[70%] ">
          ...
          <span className="sideh5"> Addis Ababa (Gerji-Roba) </span>
        </div>
        {/* Phone Number */}
        <a
          href="tel:+251941248799"
          className="justify-end flex gap-x-3 items-center min-w-[70%]"
        >
          <PhoneIcon className="h-5 text-color2" />
          <span className="sideh5">09-13-22-88-92</span>
        </a>
        {/* Email Address */}
        <button
          onClick={() => window.open("mailto:abenikeb79@gmail.com")}
          className="justify-end flex gap-x-3 items-center min-w-[70%]"
        >
